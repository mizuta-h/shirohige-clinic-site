...
if (isset($_POST["recaptchaResponse"]) && !empty($_POST["recaptchaResponse"])) {
	$secret = "6Ldhdc4qAAAAALr8bKjbxwjlAMD6hG4FA6t7SwW7";
...
$Referer_check_domain = "shirohige.clinic";
...
$thanksPage = "https://shirohige.clinic";
...
──────────────────────
医療法人社団しろひげファミリー
〒132-0014 東京都江戸川区3-55-11
TEL：03- 5666 - 4675
E-mail:info@shirohige.clinic
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="https://shirohige.clinic" target="_blank">-しろひげ在宅診療所-</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
